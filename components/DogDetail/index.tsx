      ...
      <div className="title">
        <div className="info">
          ...
          <p className="institution">
            {isInstitution ? '단체 |' : '개인 |'} {isInstitution ? '웰컴독 코리아' : '개인 구조자'}
          </p>
        </div>
        <div className="icon">
          <Report />
      ...
      <div className="content">
        ...
        <div className="dog">
          ...
          <div className="detail">
            멍멍이는 인천 남동구에서 구조된 멍멍이에요.멍멍이는 어쩌구 저쩌고 그런 강아진데요, 좋은
            기회로 해외에 입양을 가게 되었답니다. 멍멍이가 좋은 가족을 만나서 행복한 삶을 살 수
            있도록 도와주세요. 도움의 손길 어쩌구 저쩌구 저희도 어쩌구 저쩌구 멍멍이는 인천
            남동구에서 구조된 멍멍이에요.
          </div>
        </div>
      </div>
